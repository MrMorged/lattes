 ...
 * @author adelmir
 */
public class LattesReducer extends Reducer<Text, Text, Text, Text> {
    ...
    public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        ...
        reduce_config.addResource(new Path("/user/adelmir/hadoop-1.2.1/bin/core-site.xml"));
        reduce_config.addResource(new Path("/user/adelmir/hadoop-1.2.1/bin/hdfs-site.xml"));

        // Create variables
        String key_word = "";
        String check_keyword = key_word;

        keyword_file_path = new Path("/home/adelmir/hadoop-1.2.1/src/examples/keys.txt");
        FileSystem file_system_read = FileSystem.get(URI.create("/home/adelmir/hadoop-1.2.1/src/examples/keys.txt"), new Configuration());
        ...
        Path path_output = new Path("/home/adelmir/hadoop-1.2.1/examples/sentiment_output_file.txt");
        Path path_output_posneg = new Path("/home/adelmir/hadoop-1.2.1/src/examples/posneg_output_file.txt");
        ...
        if (check_keyword.equals(key.toString().toLowerCase())) {
            for (Text new_tweets : values) {
                ...
                positive_file_path = new Path("/home/adelmir/hadoop-1.2.1/examples/pos_words.txt");
                FileSystem filesystem_one = FileSystem.get(URI.create("/home/adelmir/hadoop-1.2.1/examples/pos_words.txt"), new Configuration());
                ...
                negative_file_path = new Path("/home/adelmir/hadoop-1.2.1/examples/neg_words.txt");
                FileSystem filesystem_two = FileSystem.get(URI.create("/home/adelmir/hadoop-1.2.1/examples/neg_words.txt"), new Configuration());
