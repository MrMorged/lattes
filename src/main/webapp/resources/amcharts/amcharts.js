...
AmCharts.AmChart=AmCharts.Class({
    ...
    drawChart:function(){
        var a=this.container,b=this.realWidth,d=this.realHeight,e=this.set,f=AmCharts.polygon(a,[0,b-1,b-1,0],[0,0,d-1,d-1],this.backgroundColor,this.backgroundAlpha,1,this.borderColor,this.borderAlpha);
        this.background=f;
        e.push(f);
...
write:function(a){
    ...
    if(e)switch(e.position){
        ...
        case "left":
            ...
            f.position="relative",g.position="absolute",h.appendChild(b),h.appendChild(d)
...
measure:function(){
    ...
    var g=AmCharts.removePx(AmCharts.getStyle(a,"padding-left")),h=AmCharts.removePx(AmCharts.getStyle(a,"padding-right")),i=AmCharts.removePx(AmCharts.getStyle(a,"padding-top")),j=AmCharts.removePx(AmCharts.getStyle(a,"padding-bottom"));
    isNaN(g)||(d-=g);
    isNaN(h)||(d-=h);
    isNaN(i)||(e-=i);
    isNaN(j)||(e-=j);
...
drb:function(){
    ...
    if(e!=b){
        ...
        // REMOVER PROPAGANDA AMCHARTS
        f=AmCharts.text(this.container,"IGOR","#ffffff","Verdana",00,"start");
        f.translate(7,9);
...
AmCharts.Cuboid=AmCharts.Class({
    ...
    draw:function(){
        ...
        k=this.bcolor,l=this.balpha,m=this.gradientRotation,r=this.cornerRadius,n=h,q=h;
        "object"==typeof h&&(n=h[0],q=h[h.length-1]);
        if(0<f||0<g){
            var p=q,q=AmCharts.adjustLuminosity(n,-0.2),q=AmCharts.adjustLuminosity(n,-0.2),s=AmCharts.polygon(b,[0,f,d+f,d,0],[0,g,g,0,0],q,i,0,0,0,m);
            ...
            var z=AmCharts.polygon(b,[0,0,f,f,0],[0,
                e,e+g,g,0],q,i,0,0,0,m),y=AmCharts.polygon(b,[d,d,d+f,d+f,d],[0,e,e+g,g,0],q,i,0,0,0,m);
            ...
            if(0<l)var C=AmCharts.line(b,[0,f,d+f],[e,e+g,e+g],k,l,j)
                ...
                1>Math.abs(e)&&(e=0);
        1>Math.abs(d)&&(d=0);
        b=0==e?AmCharts.line(b,[0,d],[0,0],n,l,j):0==d?AmCharts.line(b,[0,0],[0,e],n,l,j):0<r?AmCharts.rect(b,d,e,h,i,j,k,l,r,m):AmCharts.polygon(b,[0,0,d,d,0],
...
AmCharts.AmLegend=AmCharts.Class({
    ...
    arrangeEntries:function(){
        ...
        k=this.verticalGap,l=this.spacing,m=i-d-b,r=0,n=0,q=this.container,p=q.set();
        this.set=p;
        q=q.set();
        p.push(q);
    ...
    draw:function(){
        ...
        if(!isNaN(a)){
            ...
            if(this.show){
                ...
                var m=this.balloonColor,r=this.fillColor,n=this.borderColor;
                void 0!=m&&(this.adjustBorderColor?n=m:r=m);
                var q=this.horizontalPadding,p=this.verticalPadding,m=this.pointerWidth,s=this.pointerOrientation,t=this.cornerRadius,
                u=e.fontFamily,x=this.fontSize;
        ...
        for(var j=0;j<e.length;j++){
            ...
            for(var n=0;n<r.length;n++){
                ...
                for(var p=0;p<a.length;p++){
                    var m=a[p],s=m.id,t=m.periodValue;
                    if(m.valueAxis.id==q){
                        k.axes[q].graphs[s]={};
...
updatePlotArea:function(){
    var a=
    this.updateWidth()-1,b=this.updateHeight()-1,d=this.container;
    this.realWidth=a;
    this.realWidth=b;
...
AmCharts.TrendLine=AmCharts.Class({
    ...
    draw:function(){
        var a=this;
        a.destroy();
        var b=a.chart,d=b.container,e,f,g,h,i=a.categoryAxis,j=a.initialDate,k=a.initialCategory,l=a.finalDate,m=a.finalCategory,r=a.valueAxis,n=a.valueAxisX,q=a.initialXValue,p=a.finalXValue,s=a.initialValue,t=a.finalValue,u=r.recalculateToPercents;
...
timeZoom:function(a,b){
    ...
    isNaN(d)||(b!=this.endTime&&b-a>d&&(a=b-d,this.updateScrollbar=!0),a!=this.startTime&&b-a>d&&(b=a+d,this.updateScrollbar=
        !0));
    ...
    draw:function(){
        ...
        if(this.logarithmic&&(0>=this.getMin(0,this.data.length-1)||0>=this.minimum))this.fire("logarithmicAxisFailed",{
            ...
            if(!isNaN(this.min)&&
                ...
                var k=this.labelFrequency,l=this.showFirstLabel,m=this.showLastLabel,r=1,n=0,q=Math.round((this.max-this.min)/this.step)+1;
                if(!0==i){
                ...
                if(0<u){
                    ...
                    for(e=this.fillAlpha=0;e<u;e++){
                        var z=t[e],y=NaN;
                        if(!isNaN(z.toValue)){
                            var y=this.getCoordinate(z.toValue),v=new this.axisItemRenderer(this,y,"",!0,NaN,NaN,z);
                            this.pushAxisItem(v)
                            }
                            var C=NaN;
                ...
                for(e=n;e<q;e+=r)if(n=this.step*e+this.min,n=AmCharts.roundTo(n,this.maxDecCount+1),!(this.integersOnly&&Math.round(n)!=n)){
                    ...
                    t?(v=-1==String(n).indexOf("e")?n.toExponential(15):
                        String(n),v=v.split("e"),d=Number(v[0]),v=Number(v[1]),d=AmCharts.roundTo(d,14),10==d&&(d=1,v+=1),v=d+"e"+v,0==n&&(v="0"),1==n&&(v="1")):(i&&(d=String(n).split("."),s.precision=d[1]?d[1].length:-1),v=this.usePrefixes?AmCharts.addPrefix(n,a.prefixesOfBigNumbers,a.prefixesOfSmallNumbers,s):AmCharts.formatNumber(n,s,s.precision));
                    ...
                    if(n==this.baseValue&&"radar"!=j){
                        var J,E,u=this.viW,x=this.viH,n=this.viX,v=this.viY;
...
getMinMax:function(){
    ...
    if(this.includeGuidesInMinMax&&0<a)for(b=
        0;b<a;b++)d=this.guides[b],d.toValue<this.min&&(this.min=d.toValue),d.value<this.min&&(this.min=d.value),d.toValue>this.max&&(this.max=d.toValue),d.value>this.max&&(this.max=d.value);
    ...
    for(var d,e=a;e<=b;e++){
        ...
        for(g in f){
            ...
            if(h.includeInMinMax&&(!h.hidden||this.includeHidden)){
                ...
                var i;
                if(this.minMaxField)i=h[this.minMaxField],i<d&&(d=i);else for(var j in h)"percents"!=
                    j&&"total"!=j&&(i=h[j],i<d&&(d=i))
                    }
                }
        }
        return d
...
zoomToValues:function(a,b){
    ...
    d.position="V"==this.orientation?this.reversed?this.getCoordinate(a)-this.y:this.getCoordinate(b)-this.y:this.reversed?this.getCoordinate(b)-this.x:this.getCoordinate(a)-
    this.x;
    this.fire(d.type,d)
    },
...
getCoordinate:function(a){
    ...
    !0==this.logarithmic?(a=Math.log(a)*
        Math.LOG10E-Math.log(h)*Math.LOG10E,b=b?!0==d?e-f*a:f*a:!0==d?f*a:e-f*a):b=!0==d?b?e-f*(a-g):f*(a-g):b?f*(a-g):e-f*(a-g);
...
handleSynchronization:function(){
    var a=this.synchronizeWithAxis,b=a.min,d=a.max,
    a=a.step,e=this.synchronizationMultiplier;
...
AmCharts.RecItem=AmCharts.Class({
    construct:function(a,b,d,e,f,g,h,i,j){
        ...
        var r=a.chart.container,n=r.set();
        this.set=n;
        var q=a.axisThickness,p=a.axisColor,s=a.axisAlpha,t=a.tickLength,u=a.gridAlpha,x=a.gridThickness,z=a.gridColor,y=a.dashLength,v=a.fillColor,C=a.fillAlpha,J=a.labelsEnabled,E=a.labelRotation,W=a.counter,L=a.inside,
        ...
        O="start";
        f&&(O="middle");
        var R=E*Math.PI/180,ha,D=0,w=0,ga=0,da=ha=0;
        "V"==S&&(E=0);
        if(J)var T=AmCharts.text(r,d,m,k,l,O,i),da=
            T.getBBox().width;
        if("H"==S){
            ...
            0<=b&&b<=fa+1&&(0<t&&(0<s&&b+j<=fa+
                1)&&(ba=AmCharts.line(r,[0,t],[b+j,b+j],p,s,x),n.push(ba)),0<u&&(O=AmCharts.line(r,[0,N,$+N],[b,b+F,b+F],z,u,x,y),n.push(O)));
            O="end";
            ...
            w+=l/2;
            "right"==M?(D+=N+$+aa,w+=F,L?(D-=t+4,g||(w-=l/2+3)):(D+=t+4+q,w-=2)):L?(D+=t+4-aa,g||(w-=l/2+3),h&&(D+=N,w+=F)):(D+=-t-
                q-4-2-aa,w-=2);
    ...
    construct:function(a){
        ...
        if(b){
            ...
            for(var a=b.chartData,r=a.length,n=0;n<r;n++){
                var q=180-360/r*n,p=g+this.axisWidth*Math.sin(q/180*Math.PI),s=h+this.axisWidth*Math.cos(q/
                    180*Math.PI),p=AmCharts.line(b.container,[g,p],[h,s],e,f,d);
                this.set.push(p);
                if(j){
                    var t="start",p=g+(this.axisWidth+i)*Math.sin(q/180*Math.PI),s=h+(this.axisWidth+i)*Math.cos(q/180*Math.PI);
...
AmCharts.RadItem=AmCharts.Class({
    construct:function(a,b,d,e,f,g,h){
        ...
        this.set=e=l.set();
        var m=a.axisColor,r=a.axisAlpha,n=a.tickLength,q=a.gridAlpha,p=a.gridThickness,s=a.gridColor,t=a.dashLength,u=a.fillColor,x=a.fillAlpha,z=a.labelsEnabled,f=a.counter,y=a.inside,v=a.gridType,b=b-a.height,C,g=a.x,J=a.y;
        ...
        if(z){
            ...
            b=a.y-b;
        if("polygons"==v){
            for(var N=[],F=[],S=a.data.length,d=0;d<S;d++)i=180-360/S*d,N.push(b*Math.sin(i/180*Math.PI)),F.push(b*Math.cos(i/
                180*Math.PI));
            N.push(N[0]);
            F.push(F[0]);
...
createSerialGraph:function(){
    ...
    R=L.cellWidth,ha=(R*h-m)/m;
    O>ha&&(O=ha);
    var D,w,ga,da=j+1,T=i+1,Ka=0,Sa=0,Ta,Ua,La,Ma,zb=this.fillColors,Da=this.negativeFillColors,va=this.negativeLineColor,Ea=this.fillAlphas,Fa=this.negativeFillAlphas;
    ...
    if(!W&&("line"==g||"smoothedLine"==g||"step"==g))if(1==d.length&&("step"!=g&&"none"==this.bullet)&&(this.bullet=
        "round",this.resetBullet=!0),Da||void 0!=va){
        var wa=F;
        wa>f.max&&(wa=f.max);
        wa<f.min&&(wa=f.min);
        f.logarithmic&&(wa=f.minReal);
        var ra=f.getCoordinate(wa),lb=f.getCoordinate(f.max);
...
if("line"==g||"step"==g||"smoothedLine"==g)if(this.stackable&&"regular"==v||"100%"==v)Va=!0;
    ...
    w.index=K;
    var ma=NaN,
    B=NaN,A=NaN,X=NaN,U=NaN,Oa=NaN,xa=NaN,Pa=NaN,ya=NaN,V=NaN,Y=NaN,na=NaN,oa=NaN,P=NaN,ja=void 0,ta=zb,Ga=Ea,ea=fa;
    ...
    if(pa){
        ...
        if("candlestick"==g||"ohlc"==g)var P=pa.close,Wa=pa.low,xa=f.getCoordinate(Wa),Xa=pa.high,ya=f.getCoordinate(Xa);
        var ia=pa.open,A=f.getCoordinate(P);
        ...
        if(!W)switch(this.showBalloonAt){
            ...
            case "low":
                ...
                var ma=D.x[L.id],za=Math.round(R/2),Ya=za;
        ...
        switch(g){
            case "line":
                isNaN(P)?n||(this.drawLineGraph(q,p,ka,la),q=[],p=[],ka=[],la=[]):(w.isNegative=P<F?!0:!1,q.push(B),p.push(A),V=B,Y=A,na=B,oa=A,Va&&(ka.push(X),
                la.push(U)));
            break;
            case "smoothedLine":
                isNaN(P)?n||(this.drawSmoothedGraph(q,p,ka,la),q=[],p=[],ka=[],la=[]):(w.isNegative=P<F?!0:!1,q.push(B),p.push(A),V=B,Y=A,na=B,oa=A,Va&&(ka.push(X),la.push(U)));
                break;
            case "step":
                isNaN(P)?n||(t=NaN,this.drawLineGraph(q,p,ka,la),q=[],p=[],ka=[],la=[]):(w.isNegative=P<F?!0:!1,l?(isNaN(s)||(q.push(s),p.push(A-za)),p.push(A-za),q.push(B),p.push(A+Ya),q.push(B)):(isNaN(t)||(p.push(t),q.push(B-za)),q.push(B-za),p.push(A),q.push(B+Ya),p.push(A)),s=B,t=A,V=B,Y=A,na=
                B,oa=A);
            break;
            case "column":
                var Aa=ea;
                ...
                if(!(P<mb&&(ia<mb||void 0==ia)||P>nb&&ia>nb))if(l){
                    if("3d"==v)var H=A-0.5*(h+O)+O/2+y*S,I=X+z*S;else H=A-(m/2-S)*(h+O)+O/2,I=X;
                    var G=h,V=B,Y=H+h/2,na=B,oa=H+h/2;
                    H+G>j&&(G=j-H);
                    0>H&&(G+=H,H=0);
                    var Z=B-X,Ab=I,I=AmCharts.fitToBounds(I,0,i),Z=Z+(Ab-I),Z=AmCharts.fitToBounds(Z,-I,i-I+z*S);
                    ...
                    I+G>i+S*z&&(G=i-I+S*z);
                    0>I&&(G+=I,I=0);
                    var Z=A-U,Bb=H,H=AmCharts.fitToBounds(H,0,j),Z=Z+(Bb-H),Z=AmCharts.fitToBounds(Z,-H+y*S,j-H);
        ...
        case "candlestick":
            ...
            var ja=new AmCharts.Cuboid(e,G,Z,z,y,ta,Ga,M,Aa,Q,ba,r,l),bb,cb;
    ...
    case "ohlc":
        ...
        var db,eb,fb;
        if(l){
            var gb=A-h/2,gb=AmCharts.fitToBounds(gb,0,j),ob=AmCharts.fitToBounds(A,0,j),hb=A+h/2,hb=AmCharts.fitToBounds(hb,0,j);
            eb=AmCharts.line(e,[X,X],[gb,ob],ea,Q,M,$);
            0<A&&A<j&&(db=AmCharts.line(e,[Oa,Pa],[A,A],ea,Q,M,$));
            fb=AmCharts.line(e,[B,B],[ob,hb],ea,Q,M,$)
            }else{
            var ib=B-h/2,ib=AmCharts.fitToBounds(ib,0,i),pb=AmCharts.fitToBounds(B,
                0,i),jb=B+h/2,jb=AmCharts.fitToBounds(jb,0,i);
    ...
    if(this.end-this.start<=qb||0==qb){
        ...
        if(rb){
            var ca=this.createLabel(w,0,0,rb),ua=0,Ca=0,sb=ca.getBBox(),Ra=sb.width,kb=sb.height;
            switch(C){
                case "left":
                    ua=
                    -(Ra/2+Ba/2+3);
            ...
            var ub=f.totalText;
            if(ub){
                var Ha=this.createLabel(w,0,0,ub),vb=Ha.getBBox(),wb=vb.width,xb=vb.height,Ia,Ja,yb=f.totals[K];
                yb&&yb.remove();
...
if("line"==g||
    "step"==g||"smoothedLine"==g)"smoothedLine"==g?this.drawSmoothedGraph(q,p,ka,la):this.drawLineGraph(q,p,ka,la),W||this.launchAnimation()
    },
...
drawLineGraph:function(a,b,d,e){
    if(1<a.length){
        ...
        l=this.dashLength,f=this.fillAlphas,m=this.fillColors,r=this.negativeLineColor,n=this.negativeFillColors,q=this.negativeFillAlphas,p=this.baseCoord,s=AmCharts.line(g,a,b,this.lineColor,j,k,l,!1,!0);
        h.push(s);
        void 0!=r&&(j=AmCharts.line(g,a,b,r,j,k,l,!1,!0),i.push(j));
        if(0<f&&(j=a.join(";").split(";"),k=b.join(";").split(";"),"serial"==this.chartType&&(0<d.length?(d.reverse(),e.reverse(),j=a.concat(d),k=b.concat(e)):this.rotate?(k.push(k[k.length-1]),j.push(p),k.push(k[0]),j.push(p),k.push(k[0]),j.push(j[0])):
            (j.push(j[j.length-1]),k.push(p),j.push(j[0]),k.push(p),j.push(a[0]),k.push(k[0]))),a=AmCharts.polygon(g,j,k,m,f,0,0,0,this.gradientRotation),h.push(a),n||void 0!=r))q||(q=f),n||(n=r),g=AmCharts.polygon(g,j,k,n,q,0,0,0,this.gradientRotation),i.push(g);
        this.applyMask(i,h)
        }
    },
...
drawSmoothedGraph:function(a,b,d,e){
    if(1<a.length){
        var f=this.set,g=this.container,h=g.set(),
        i=g.set();
        f.push(h);
        f.push(i);
        var j=this.lineAlpha,k=this.lineThickness,f=this.dashLength,l=this.fillAlphas,m=this.fillColors,r=this.negativeLineColor,n=this.negativeFillColors,q=this.negativeFillAlphas,p=this.baseCoord,s=new AmCharts.Bezier(g,a,b,this.lineColor,j,k,m,0,f);
        h.push(s.path);
        void 0!=r&&(j=new AmCharts.Bezier(g,a,b,r,j,k,m,0,f),i.push(j.path));
        if(0<l&&(k=a.join(";").split(";"),s=b.join(";").split(";"),j="",0<d.length?(d.reverse(),e.reverse(),k=a.concat(d),s=b.concat(e)):(this.rotate?(j+=
            " L"+p+","+b[b.length-1],j+=" L"+p+","+b[0]):(j+=" L"+a[a.length-1]+","+p,j+=" L"+a[0]+","+p),j+=" L"+a[0]+","+b[0]),d=new AmCharts.Bezier(g,k,s,NaN,0,0,m,l,f,j),h.push(d.path),n||void 0!=r))q||(q=l),n||(n=r),a=new AmCharts.Bezier(g,a,b,NaN,0,0,n,q,f,j),i.push(a.path);
        this.applyMask(i,h)
        }
    },
...
animate:function(a){
    var b=this.chart,d=this.container,
...
createBullet:function(a,b,d){
    ...
    if("none"!=this.bullet||a.bullet){
        ...
        switch(f){
            ...
            case "triangleRight":
                i=
                AmCharts.triangle(e,g,90,j,m,h,k,l);
                break;
            case "bubble":
...
AmCharts.ChartCursor=AmCharts.Class({
    ...
    createCursor:function(){
        ...
        d.position,f=d.inside,g=d.axisThickness,h=this.categoryBalloon,i,j,k=a.dx,l=a.dy,m=this.x,r=this.y,n=this.width,q=this.height,a=a.rotate,p=d.tickLength;
        h.pointerWidth=p;
        a?(i=[0,n,n+k],j=[0,0,l]):(i=[k,0,0],j=[l,0,q-1]);
        this.line=b=AmCharts.line(this.container,i,j,this.cursorColor,b,1);
        this.set.push(b);
        a?(f&&(h.pointerWidth=0),"right"==e?f?h.setBounds(m,r+l,m+n+k,r+q+l):h.setBounds(m+n+k+g,r+l,m+n+1E3,r+q+l):f?h.setBounds(m,r,n+m,q+r):h.setBounds(-1E3,-1E3,m-p-g,r+q+15)):(h.maxWidth=n,d.parseDates&&
            (p=0,h.pointerWidth=0),"top"==e?f?h.setBounds(m+k,r+l,n+k+m,q+r):h.setBounds(m+k,-1E3,n+k+m,r+l-p-g):f?h.setBounds(m,r,n+m,q+r-p):h.setBounds(m,r+q+p+g-1,m+n,r+q+p+g));
        this.hideCursor()
        },
...
updateCursor:function(a,b){
    ...
    if(this.enabled){
        void 0==b&&(b=!0);
        this.index=a;
        var g=d.categoryAxis,h=d.dx,i=d.dy,j=this.x,k=this.y,l=this.width,m=this.height,r=this.data[a],n=r.x[g.id],q=d.rotate,p=g.inside,s=this.stepWidth,t=this.categoryBalloon,u=this.firstTime,x=this.lastTime,z=this.cursorPosition,y=g.position,v=this.zooming,C=this.panning,
        J=d.graphs,E=g.axisThickness;
        ...
        u=!0;
        v&&(u=!1);
        this.categoryBalloonEnabled&&u?(q?(p&&("right"==y?
    ...
    if(this.drawingNow){
        ...
        if(this.pan)this.rolledOver=!1;
            ...
            if("cursor"==this.type)this.rotate?this.selectionPosY=d:this.selectionPosX=d=b,2>Math.abs(d-this.initialMouse)&&this.fromIndex==this.index||(this.index<this.fromIndex?(a.end=this.fromIndex,a.start=this.index):(a.end=this.index,a.start=this.fromIndex),d=this.chart.categoryAxis,d.parseDates&&!d.equalSpacing&&(a.start=this.data[a.start].time,a.end=
                this.data[a.end].time),this.skipZoomDispatch||this.fire(a.type,a));
            else{
...
AmCharts.SimpleChartScrollbar=AmCharts.Class({
    ...
    updateScrollbar:function(){
        ...
        a=this.initialMouse;
        l.mouseIsOver&&(this.dragging&&(l=this.initialCoord,k?(a=l+(q-a),0>a&&(a=0),l=r-i,a>l&&(a=l),h.setAttr("y",a)):(a=l+(n-a),0>a&&(a=0),l=m-j,a>l&&(a=l),h.setAttr("x",a))),this.resizingRight&&
    ...
    draw:function(){
        ...
        if(k=a.graph){
            ...
            for(var g=Infinity,h=-Infinity,n=0;n<d.length;n++){
                var q=d[n].axes[r.id].graphs[k.id].values,p;
...
AmCharts.rect=function(a,b,d,e,f,g,h,i,j,k){
    ...
    void 0==h&&(h=l);
    void 0==i&&(i=f);
    var b=Math.round(b),d=Math.round(d),r=0,n=0;
...
AmCharts.wedge=function(a,b,d,e,f,g,h,i,j,k,l){
    var m=Math.round,g=m(g),h=m(h),i=m(i),r=m(h/g*i),n=AmCharts.VML;
    -359.95>=f&&(f=-359.95);
    var q=1/180*Math.PI,p=b+Math.cos(e*q)*i,s=d+Math.sin(-e*q)*r,t=b+Math.cos(e*q)*g,u=d+Math.sin(-e*q)*h,x=b+Math.cos((e+f)*q)*g,z=d+Math.sin((-e-f)*q)*h,y=b+Math.cos((e+f)*q)*i,q=d+Math.sin((-e-f)*q)*r,v={
        fill:AmCharts.adjustLuminosity(k.fill,-0.2),
        "stroke-opacity":0
    },C=0;
    180<Math.abs(f)&&(C=1);
    var e=a.set(),J;
    n&&(p=m(10*p),t=m(10*t),x=m(10*x),y=m(10*y),s=m(10*s),u=
        m(10*u),z=m(10*z),q=m(10*q),b=m(10*b),j=m(10*j),d=m(10*d),g*=10,h*=10,i*=10,r*=10,1>Math.abs(f)&&(1>=Math.abs(x-t)&&1>=Math.abs(z-u))&&(J=!0));
    f="";
    if(0<j){
        n?(path=" M"+p+","+(s+j)+" L"+t+","+(u+j),J||(path+=" A"+(b-g)+","+(j+d-h)+","+(b+g)+","+(j+d+h)+","+t+","+(u+j)+","+x+","+(z+j)),path+=" L"+y+","+(q+j),0<i&&(J||(path+=" B"+(b-i)+","+(j+d-r)+","+(b+i)+","+(j+d+r)+","+y+","+(j+q)+","+p+","+(j+s)))):(path=" M"+p+","+(s+j)+" L"+t+","+(u+j),path+=" A"+g+","+h+",0,"+C+",1,"+x+","+(z+j)+" L"+y+","+
            (q+j),0<i&&(path+=" A"+i+","+r+",0,"+C+",0,"+p+","+(s+j)));
        path+=" Z";
        c=a.path(path,void 0,void 0,"1000,1000").attr(v);
        e.push(c);
        var E=a.path(" M"+p+","+s+" L"+p+","+(s+j)+" L"+t+","+(u+j)+" L"+t+","+u+" L"+p+","+s+" Z",void 0,void 0,"1000,1000").attr(v),j=a.path(" M"+x+","+z+" L"+x+","+(z+j)+" L"+y+","+(q+j)+" L"+y+","+q+" L"+x+","+z+" Z",void 0,void 0,"1000,1000").attr(v);
        e.push(E);
        e.push(j)
        }
        n?(J||(f=" A"+m(b-g)+","+m(d-h)+","+m(b+g)+","+m(d+h)+","+m(t)+","+m(u)+","+m(x)+","+m(z)),g=" M"+m(p)+","+
        m(s)+" L"+m(t)+","+m(u)+f+" L"+m(y)+","+m(q)):g=" M"+p+","+s+" L"+t+","+u+(" A"+g+","+h+",0,"+C+",1,"+x+","+z)+" L"+y+","+q;
    ...
    if(AmCharts.ifArray(b)){
        if(0<a.realWidth&&0<a.realHeight){
            ...
            for(l=0;l<b.length;l++)if(f=b[l],!0!=f.hidden&&0<f.percents){
                var s=360*-f.percents/100,j=Math.cos((g+s/2)/180*Math.PI),p=Math.sin((-g-s/2)/180*Math.PI)*(k/n),i={
                    fill:f.color,
...
handleCursorZoom:function(a){
    var b=this.widthMultiplier*this.plotAreaWidth/a.selectionWidth,d=this.heightMultiplier*this.plotAreaHeight/a.selectionHeight,b=this.fitMultiplier(b),d=this.fitMultiplier(d);
...
handleAxisSelfZoom:function(a){
    if("H"==a.valueAxis.orientation){
        var b=this.fitMultiplier(a.multiplier),a=-a.position/this.widthMultiplier*b,d=-(this.plotAreaWidth*b-this.plotAreaWidth);
        a<d&&(a=d);
        this.horizontalPosition=a;
        this.widthMultiplier=b
        }else b=this.fitMultiplier(a.multiplier),a=-a.position/this.heightMultiplier*b,d=-(this.plotAreaHeight*b-this.plotAreaHeight),a<d&&(a=d),this.verticalPosition=a,this.heightMultiplier=
        b;
    this.zoomChart();
    this.zoomScrollbars()
    },
...
svgPathToVml:function(a){
    for(var b=a.split(" "),
        ...
        "Z"==h&&(a+=" x e");
        if("Q"==h){
            var k=d.length,l=d[k-1],m=i[0],r=i[1],j=i[2],n=i[3];
            d=e(d[k-2]/3+2/3*m);
            l=e(l/3+2/3*r);
            m=e(2/3*m+j/3);
            r=e(2/3*r+n/3);
